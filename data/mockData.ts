...
export const mockProblems: Problem[] = [
  ...
  {
    id: '6',
    title: 'Lixo Acumulado - Rua da Cocotá',
    description: 'Grande acúmulo de lixo na esquina da Rua da Cocotá com Rua Tiradentes. O lixo está espalhado pela calçada há mais de uma semana, atraindo ratos e insetos.',
    category: 'cleaning',
    status: 'pending',
    priority: 'high',
    location: {
      latitude: -22.815234,
      longitude: -43.195876,
      address: 'Rua da Cocotá, 245 - Cocotá, Rio de Janeiro - RJ',
    },
    images: [
      'https://www.correiodopovo.com.br/image/contentid/policy:1.835863:1677755916/lixoALS.jpeg.jpeg?a=2%3A1&$p$a=72124cc',
    ],
  ...
  {
    id: '7',
    title: 'Poste de Luz Quebrado - Rua dos Bancários',
    ...
    location: {
      latitude: -22.801567,
      longitude: -43.191234,
      address: 'Rua dos Bancários, 890 - Bancários, Rio de Janeiro - RJ',
    },
    images: [
      'https://www.clickguarulhos.com.br/wp-content/uploads/2019/07/20190730-lampada-queimada_palmira-rossi_recreio-sao-jorge-1.jpeg',
    ],
  ...
  {
    id: '8',
    title: 'Buraco na Estrada da Ribeira',
    description: 'Buraco profundo na via principal da Ribeira, próximo ao posto de gasolina. O buraco está causando danos aos veículos e é um risco constante para os motoristas.',
    category: 'road',
    status: 'in_progress',
    priority: 'high',
    location: {
      latitude: -22.825678,
      longitude: -43.188901,
      address: 'Estrada da Ribeira, 1450 - Ribeira, Rio de Janeiro - RJ',
    },
    images: [
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkfiX6VxBp9L3GvGR69wKo7zUQv-l4N9vv-A&s',
    ],
  ...
  {
    id: '9',
    title: 'Entulho Abandonado - Rua Portuguesa',
    ...
    location: {
      latitude: -22.812345,
      longitude: -43.202456,
      address: 'Rua Portuguesa, 567 - Portuguesa, Rio de Janeiro - RJ',
    },
    images: [
      'https://www.correiodopovo.com.br/image/contentid/policy:1.835863:1677755916/lixoALS.jpeg.jpeg?a=2%3A1&$p$a=72124cc',
    ],
  ...
  {
    id: '10',
    title: 'Sinalização Apagada - Av. Maestro Júlio Cristóbal',
    description: 'Placa de sinalização de trânsito completamente desbotada e ilegível na principal avenida da Ilha. Motoristas estão confusos sobre as direções.',
    category: 'others',
    status: 'pending',
    priority: 'medium',
    location: {
      latitude: -22.806789,
      longitude: -43.189567,
      address: 'Av. Maestro Júlio Cristóbal, 2100 - Jardim Carioca, Rio de Janeiro - RJ',
    },
    images: [],
    reportedBy: '8',
  ...
  {
    id: '11',
    title: 'Esgoto Vazando - Rua do Zumbi',
    ...
    location: {
      latitude: -22.820123,
      longitude: -43.193456,
      address: 'Rua do Zumbi, 123 - Zumbi, Rio de Janeiro - RJ',
    },
    images: [],
    reportedBy: '6',
  ...
  {
    id: '12',
    title: 'Árvore Caída - Praça da Freguesia',
    description: 'Árvore de grande porte caiu durante o temporal e está bloqueando totalmente a passagem na praça. Risco de acidentes e impedimento do trânsito local.',
    category: 'others',
    status: 'resolved',
    priority: 'high',
    location: {
      latitude: -22.813567,
      longitude: -43.196789,
      address: 'Praça da Freguesia, s/n - Freguesia, Rio de Janeiro - RJ',
    },
    images: [],
    reportedBy: '10',
  ...
  {
    id: '13',
    title: 'Calçada Irregular - Rua Cambaúba',
    ...
    location: {
      latitude: -22.807234,
      longitude: -43.187654,
      address: 'Rua Cambaúba, 345 - Jardim Carioca, Rio de Janeiro - RJ',
    },
    images: [
      'https://portal-arquivos.engeplus.com.br/cache/noticia/geral/2012/calcada-danificada-e-responsabilidade-do-morador/calcada-danificada-e-responsabilidade-do-morador-933618.jpg',
    ],
  ...
  {
    id: '14',
    title: 'Lâmpadas Queimadas - Rua Baependi',
    ...
    location: {
      latitude: -22.799876,
      longitude: -43.184321,
      address: 'Rua Baependi, 678 - Tauá, Rio de Janeiro - RJ',
    },
    images: [
      'https://www.clickguarulhos.com.br/wp-content/uploads/2019/07/20190730-lampada-queimada_palmira-rossi_recreio-sao-jorge-1.jpeg',
    ],
  ...
  {
    id: '15',
    title: 'Ponto de Ônibus Destruído - Estrada do Dendê',
    ...
    location: {
      latitude: -22.822345,
      longitude: -43.205678,
      address: 'Estrada do Dendê, 1890 - Freguesia, Rio de Janeiro - RJ',
    },
    images: [],
    reportedBy: '6',
